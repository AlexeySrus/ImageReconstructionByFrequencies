...
python3 pytorch_fourier_train.py \
    ...
    --visdom 9002 \
    --njobs 4 \
    --exp /media/alexey/SSDData/experiments/denoising/denoising_unet_orig/ \
    --preload_datasets \
    # --load "/media/alexey/SSDData/experiments/denoising/denoising_unet_fftattn/checkpoints/last.trh"
