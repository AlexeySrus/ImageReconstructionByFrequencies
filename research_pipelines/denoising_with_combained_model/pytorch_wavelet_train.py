...
from FFTCNN.unet import FFTAttentionUNetWithWavelets, init_weights
...
class CustomTrainingPipeline(object):
    def __init__(self,
        ...
        self.model = FFTAttentionUNetWithWavelets()
        ...
        self.wavelets_criterion = torch.nn.SmoothL1Loss() # SparceLoss()
